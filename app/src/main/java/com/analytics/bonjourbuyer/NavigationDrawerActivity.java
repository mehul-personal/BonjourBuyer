...
//		AddressBar.setTypeface(regularFont);
	...
	public void updateLocation(final String locationId) {
		...
		String url = ApplicationData.serviceURL + "update_location.php";
		Log.e("url", url + "");
		...
		StringRequest jsonObjReq = new StringRequest(Request.Method.POST, url,
			...
			protected Map<String, String> getParams() {
				...
				params.put("name", location_name);
				params.put("latitude", center_poistion.latitude + "");
				params.put("longitude", center_poistion.longitude + "");
				return params;
			}
		};
	...
	public void saveLocation() {
		...
		String url = ApplicationData.serviceURL + "save_location.php";
		Log.e("url", url + "");
		final ProgressDialog mProgressDialog = new ProgressDialog(NavigationDrawerActivity.this);
		mProgressDialog.setTitle("");
		mProgressDialog.setCanceledOnTouchOutside(false);
