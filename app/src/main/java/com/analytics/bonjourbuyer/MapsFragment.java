...
public class MapsFragment extends Fragment implements OnMapReadyCallback, GoogleMap.OnCameraChangeListener, LocationListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        imvSellerzone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
                    PackageManager pm = getActivity().getPackageManager();
                    Intent launchIntent = pm.getLaunchIntentForPackage("com.analytics.bonjourseller");
                    startActivity(launchIntent);
                }catch(Exception e){
                    Toast.makeText(getActivity(),"Users Apps not available \nYou can download on play store!",Toast.LENGTH_LONG).show();
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/details?id=com.analytics.bonjourseller")));
                                ...
                                try {
                                    ...
                                    if (msg.equalsIgnoreCase("Success")) {
                                        ...
                                        Toast.makeText(getActivity(),
                                                "Oopss! We can't found your nearest offer",
